 ...
 * 
 *      Purpose: Display the high scores to the user. At this point
 *      high scores are not being implemented so the values are
 *      arbitrary.
 *************************************************************************/
package Hangman;
...
public class HighScoreScreen extends JPanel {
    ...
    public HighScoreScreen() {
        ...
        //intialize the arrays to arbitrary values
        for(int i = 0; i < 5; i++) {
            names[i] = "AAA";
            scores[i] = "0";
        }
